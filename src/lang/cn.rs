...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ("Status", "状态"),
        ("Your Desktop", "RustDesk专业版"),
        ("desk_tip", "技术支持:Br00wn"),
        ("Password", "密码"),
        ("Ready", "就绪"),
        ("Established", "已建立"),
        ...
        ("Set Password", "设置密码"),
        ("OS Password", "操作系统密码"),
        ("install_tip", "当前为未安装版本,技术支持:Br00wn"),
        ...
        ("Request access to your device", "技术支持:Br00wn"),
        ...
        ("{} sessions", "{} 个会话"),
        ("scam_title", "技术支持:Br00wn"),
        ("scam_text1", "技术支持:Br00wn"),
        ("scam_text2", "技术支持:Br00wn"),
